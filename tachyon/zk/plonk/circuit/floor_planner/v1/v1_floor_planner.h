...
#ifndef TACHYON_ZK_PLONK_CIRCUIT_FLOOR_PLANNER_V1_V1_FLOOR_PLANNER_H_
#define TACHYON_ZK_PLONK_CIRCUIT_FLOOR_PLANNER_V1_V1_FLOOR_PLANNER_H_
...
#include "tachyon/zk/plonk/circuit/floor_planner/v1/v1_pass.h"
 ...
 public:
  ...
  void Synthesize(Assignment<F>* assignment, CircuitTy& circuit,
    ...
    MeasurementPass<F> measure;
    {
      ...
      circuit.WithoutWitness()->Synthesize(std::move(config.Clone()), &pass);
    }
...
#endif  // TACHYON_ZK_PLONK_CIRCUIT_FLOOR_PLANNER_V1_V1_FLOOR_PLANNER_H_
